        ...
        for (int i = 0; i < arr.Length - 1; i++)
        {
            for (int j = 0; j < arr.Length - i - 1; j++)
            {
                if (arr[j] > arr[j + 1])
                {
                    ...
                    arr[j] = arr[j + 1];
                    arr[j + 1] = temp;
                    var updates_18_2 = TestVariableTracker.TrackVariables(18, ("arr", arr), ("j", j), ("i", i));
                    if (updates_18_2.ContainsKey("arr")) arr = (int[])updates_18_2["arr"];
                    if (updates_18_2.ContainsKey("j")) j = (int)updates_18_2["j"];
                    if (updates_18_2.ContainsKey("i")) i = (int)updates_18_2["i"];
                }
                var updates_19_1 = TestVariableTracker.TrackVariables(19, ("arr", arr), ("i", i));
                if (updates_19_1.ContainsKey("arr")) arr = (int[])updates_19_1["arr"];
                if (updates_19_1.ContainsKey("i")) i = (int)updates_19_1["i"];
            }
            var updates_20_0 = TestVariableTracker.TrackVariables(20, ("arr", arr));
            if (updates_20_0.ContainsKey("arr")) arr = (int[])updates_20_0["arr"];
        }
...
public static class TestVariableTracker
{
    ...
    private static string _codeId = "37_749467";
