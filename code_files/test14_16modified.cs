...
class Program
{
    ...
    {
    TestVariableTracker.Initialize("14_16", "/app/code_files/14_16_userdata.txt");
        int[] array = { 3,4,5,2,1 };
        ...
        for (int i = 1; i < array.Length; i++)
        {
            ...
            array[j + 1] = key;
    var updates_24_0 = TestVariableTracker.TrackVariables(24, 1, ("array", array));
    if (updates_24_0.ContainsKey("array")) array = (int[])updates_24_0["array"];
        }
