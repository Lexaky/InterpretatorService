        ...
        for (int i = 0; i < arr.Length - 1; i++)
        {
            for (int j = 0; j < arr.Length - i - 1; j++)
            {
                if (arr[j] > arr[j + 1])
                {
                    ...
                    if (updates_18_2.ContainsKey("j")) j = updates_18_2["j"];
                    if (updates_18_2.ContainsKey("i")) i = updates_18_2["i"];
                }
                ...
                if (updates_19_1.ContainsKey("i")) i = updates_19_1["i"];
            }
...
public static class TestVariableTracker
{
    ...
    private static string _codeId = "36_365969";
