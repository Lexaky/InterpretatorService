...
class Program
{
    ...
    {
    TestVariableTracker.Initialize("70_815380", "/app/code_files/70_815380_userdata.txt");
        ...
        {
            sum += number;
    var updates_12_0 = TestVariableTracker.TrackVariables(12, 1, ("numbers", numbers), ("sum", sum));
    ...
    var updates_14_1 = TestVariableTracker.TrackVariables(14, 2, ("sum", sum));
    if (updates_14_1.ContainsKey("sum")) sum = (int)updates_14_1["sum"];
