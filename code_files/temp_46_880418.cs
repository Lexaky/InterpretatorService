...
class Program
{
    ...
    {
    TestVariableTracker.Initialize("46_880418", "/app/code_files/46_880418_userdata.txt");
        int[] numbers = { 1,2,3,4,5,6,7 };
        int sum = 0;

        foreach (int number in numbers)
        {
        var updates_11_1 = TestVariableTracker.TrackVariables(11, ("sum", sum));
        if (updates_11_1.ContainsKey("sum")) sum = (int)updates_11_1["sum"];
            sum += number;
            var updates_12_0 = TestVariableTracker.TrackVariables(12, ("numbers", numbers), ("sum", sum));
            if (updates_12_0.ContainsKey("numbers")) numbers = (int[])updates_12_0["numbers"];
...
public static class TestVariableTracker
{
    ...
    private static string _codeId = "46_880418";
