...
class Program
{
    static void Main(string []args)
    {
        ...
        {
        var updates_11_1 = TestVariableTracker.TrackVariables(11, ("numbers", numbers), ("sum", sum));
        if (updates_11_1.ContainsKey("numbers")) numbers = (int[])updates_11_1["numbers"];
        if (updates_11_1.ContainsKey("sum")) sum = (int)updates_11_1["sum"];
            sum += number;
            var updates_12_0 = TestVariableTracker.TrackVariables(12, ("sum", sum));
...
public static class TestVariableTracker
{
    ...
    private static string _codeId = "44_441236";
