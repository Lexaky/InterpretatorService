...
class Program
{
    ...
    {
    TestVariableTracker.Initialize("72_872727", "/app/code_files/72_872727_userdata.txt");
        int[] arr = { 5,4,3,2,1 };
    ...
    var updates_19_0 = TestVariableTracker.TrackVariables(19, 1, ("arr", arr), ("j", j), ("i", i));
    if (updates_19_0.ContainsKey("arr")) arr = (int[])updates_19_0["arr"];
    if (updates_19_0.ContainsKey("j")) j = (int)updates_19_0["j"];
    if (updates_19_0.ContainsKey("i")) i = (int)updates_19_0["i"];
            }
    var updates_20_1 = TestVariableTracker.TrackVariables(20, 2, ("arr", arr), ("i", i));
    if (updates_20_1.ContainsKey("arr")) arr = (int[])updates_20_1["arr"];
    if (updates_20_1.ContainsKey("i")) i = (int)updates_20_1["i"];
        }
    var updates_21_2 = TestVariableTracker.TrackVariables(21, 3, ("arr", arr));
    if (updates_21_2.ContainsKey("arr")) arr = (int[])updates_21_2["arr"];
